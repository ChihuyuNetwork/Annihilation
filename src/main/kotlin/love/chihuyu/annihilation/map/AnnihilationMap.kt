...
class AnnihilationMap(
    ...
    var midBuffs: MutableList<Location> = mutableListOf(),
    var witchSpawns: MutableList<Location> = mutableListOf()
    ...
    constructor(map: MutableMap<String, Any>) : this(
        ...
        map["midBuffs"] as MutableList<Location>,
        map["witchSpawns"] as MutableList<Location>
    )
    ...
    override fun serialize(): MutableMap<String, Any> {
        return mutableMapOf(
            ...
            "midBuffs" to midBuffs,
            "witchSpawns" to witchSpawns
        )
    }
}
